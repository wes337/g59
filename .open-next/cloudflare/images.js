...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:cdn\\.shopify\\.com)$)$", port: "", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }, { protocol: "https", hostname: "^(?:^(?:w\\-img\\.b\\-cdn\\.net)$)$", port: "", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }];
...
// node_modules/.pnpm/@opennextjs+cloudflare@1.16.2_next@16.0.10_@babel+core@7.28.5_react-dom@19.2.3_react@19_4491e2804b5d4513e0d9f9a533f1f7fd/node_modules/@opennextjs/cloudflare/dist/cli/templates/images.js
