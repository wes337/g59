  ...
  return (
    <div className="flex flex-col w-full md:w-auto">
      <div className="flex flex-col w-full md:flex-row gap-8 md:bg-black/75">
        <div className="relative w-full h-[50vh] md:w-[52.5vw] md:h-[70vh] bg-white/10">
          {product.images.length > 1 && (
            <>
              <button
                className="cursor-pointer absolute text-left top-0 left-0 w-[50%] h-full text-4xl tracking-[-2px] text-shadow-[4px_4px_0px_black] text-gray-300 hover:text-yellow-300 active:text-yellow-300"
                onClick={gotoNextImage}
              >
                &lt;&lt;
              </button>
              <button
                className="cursor-pointer absolute text-right top-0 right-0 w-[50%] h-full text-4xl tracking-[-2px] text-shadow-[4px_4px_0px_black] text-gray-300 hover:text-yellow-300 active:text-yellow-300"
                onClick={gotoPreviousImage}
              >
                &gt;&gt;
              </button>
              <div className="absolute bottom-0 right-0 md:left-0 md:right-[auto] md:w-full md:text-center text-shadow-[2px_2px_0px_black] text-lg tracking-tighter select-none pointer-events-none text-yellow-100">
